...
const mockClients: Client[] = [
  {
    id: 'C-001',
    name: 'Nina Czarnecka',
    phone: '+48 606 124 889',
    email: 'nina.czarnecka@sunline-demo.test',
    agent: 'I. Kaczmarek',
    budget: 7400,
    destinations: ['Sycylia', 'Kreta', 'Riwiera Turecka'],
    contactConsent: { phone: true, email: true }
  },
  {
    id: 'C-002',
    name: 'Oskar Fronczak',
    phone: '+48 731 558 402',
    email: 'oskar.fronczak@client-lab.test',
    agent: 'R. Urbaniak',
    budget: 5100,
    destinations: ['Cypr', 'Malta', 'Kos'],
    contactConsent: { phone: false, email: true }
  },
  {
    id: 'C-003',
    name: 'Renata Biernacka',
    phone: '+48 517 903 114',
    email: 'renata.biernacka@holiday-sim.test',
    agent: 'D. Wolski',
    budget: 12800,
    destinations: ['Bali', 'Lombok', 'Langkawi'],
    contactConsent: { phone: true, email: false }
  },
  {
    id: 'C-004',
    name: 'Milosz Wnorowski',
    phone: '+48 792 446 305',
    email: 'milosz.wnorowski@trip-sandbox.test',
    agent: 'J. Kurek',
    budget: 3900,
    destinations: ['Hurghada', 'Marsa Alam'],
    contactConsent: { phone: false, email: true }
  },
  {
    id: 'C-005',
    name: 'Karolina Potocka',
    phone: '+48 664 209 771',
    email: 'karolina.potocka@voyage-demo.test',
    agent: 'I. Kaczmarek',
    budget: 15400,
    destinations: ['Dominikana', 'Zanzibar', 'Mauritius'],
    contactConsent: { phone: true, email: true }
  },
  {
    id: 'C-006',
    name: 'Mateusz Seliga',
    phone: '+48 602 347 668',
    email: 'mateusz.seliga@crm-fixture.test',
    agent: 'R. Urbaniak',
    budget: 6200,
    destinations: ['Albania', 'Czarnogora', 'Korfu'],
    contactConsent: { phone: true, email: false }
  },
  {
    id: 'C-007',
    name: 'Paulina Dylewska',
    phone: '+48 739 118 054',
    email: 'paulina.dylewska@travel-lab.test',
    agent: 'D. Wolski',
    budget: 8700,
    destinations: ['Teneryfa', 'Gran Canaria', 'Fuerteventura'],
    contactConsent: { phone: false, email: true }
  },
  {
    id: 'C-008',
    name: 'Szymon Janicki',
    phone: '+48 728 661 490',
    email: 'szymon.janicki@agency-sandbox.test',
    agent: 'J. Kurek',
    budget: 9800,
    destinations: ['Dubaj', 'Abu Dhabi', 'Doha'],
    contactConsent: { phone: true, email: true }
  }
];
